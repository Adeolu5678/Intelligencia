...
export interface AnimatedLayerButtonLinkProps
  extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  children: React.ReactNode;
  href: string;
}

const animatedLayerButtonClassName = "animated-layer-button";
...
>(({ className, children, type = "button", ...props }, ref) => {
  return (
    <button
      className={cn(animatedLayerButtonClassName, className)}
      ref={ref}
      type={type}
      {...props}
    >
      <svg
        className="animated-layer-button__orb"
      ...
      >
        ...
        />
        <path
          fill="var(--animated-button-primary)"
        ...
        />
        <path
          fill="var(--animated-button-primary-foreground)"
      ...
      <span className="animated-layer-button__label">{children}</span>
    </button>
  );
});
...
function AnimatedLayerButtonLink({
  className,
  children,
  href,
  ...props
}: AnimatedLayerButtonLinkProps) {
  return (
    <Link
      className={cn(animatedLayerButtonClassName, className)}
      href={href}
...
export { AnimatedLayerButton, AnimatedLayerButtonLink };
